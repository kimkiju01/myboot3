...
public class BoardControllerImpl  implements BoardController{
	...
	public ModelAndView selectAllArticlesList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List articlesList = boardService.selectAllArticlesList();
	...
	@ResponseBody
	public ResponseEntity insertNewArticle(MultipartHttpServletRequest multipartRequest, 
	...
	public ResponseEntity addReply(
		...
		int asd = articleVO.getArticleNO();
		articleMap.put("parentNO", asd);
		articleMap.put("id", id);
		articleMap.put("imageFileName", imageFileName);
...
*/
	...
	@RequestMapping(value = "/board/*Form.do", method =  RequestMethod.POST)
	private ModelAndView form1(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = (String)request.getAttribute("viewName");
		ModelAndView mav = new ModelAndView();
		mav.setViewName(viewName);
		return mav;
